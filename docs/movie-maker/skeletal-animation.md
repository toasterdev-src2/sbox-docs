...
You'll also need to be in the [Motion Editor](/movie-maker/motion-editing.md) to do the modifications described in this tutorial.
...
:::tip
You should know the basics of [Motion Editing](/movie-maker/motion-editing.md) before getting started here.
